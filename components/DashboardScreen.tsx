            ...
            {isAdding && (
                <div className="mt-4 pt-4 border-t border-white/10 space-y-4">
                    ...
                    <div>
                        ...
                        <div className="mt-1 block w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-gray-400">
          ...
          {investments.length > 0 && selectedInvestment ? (
            <>
              <select 
                ...
                className="mb-4 block w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:ring-indigo-500 focus:border-indigo-500"
                >
