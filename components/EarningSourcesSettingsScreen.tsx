...
const EarningSourcesSettingsScreen: React.FC<EarningSourcesSettingsScreenProps> = ({
  ...
  return (
    <div className="p-4 md:p-6">
        <div className="flex items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-100">Earning Sources</h1>
        </div>
...
export default EarningSourcesSettingsScreen;