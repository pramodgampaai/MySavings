    ...
    <div className="p-4 md:p-6 min-h-screen">
        ...
        <form onSubmit={handleAddOrUpdateEarningSource} className="flex flex-col gap-2">
            ...
            <input
                ...
                className="flex-grow px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg shadow-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-base text-white"
            />
