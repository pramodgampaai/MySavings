...
export const NoDataIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const CogIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.95.548.056 1.04.47 1.13.95.09.542-.23 1.13-.77 1.34A4.507 4.507 0 0 0 10.5 6.518a4.5 4.5 0 0 0 2.406 2.406 4.507 4.507 0 0 0 1.25.215c.548.056 1.04.47 1.13.95.09.542-.23 1.13-.77 1.34a4.507 4.507 0 0 0-1.25.216 4.5 4.5 0 0 0-2.406 2.406 4.507 4.507 0 0 0-.215 1.25c-.056.548-.47 1.04-.95 1.13-.542.09-1.13-.23-1.34-.77a4.507 4.507 0 0 0-.216-1.25 4.5 4.5 0 0 0-2.406-2.406 4.507 4.507 0 0 0-1.25-.215c-.548-.056-1.04-.47-.95-1.13.09-.542.56-1.007 1.11-.95.548.056.97.47.95 1.13.056.548.47 1.04 1.13.95.542-.09 1.007-.56 1.007-1.11V6.518a4.5 4.5 0 0 0-2.406-2.406 4.507 4.507 0 0 0-1.25-.215c-.548-.056-1.04-.47-.95-1.13.09-.542.56-1.007 1.11-.95Z" />
...
export const ClipboardDocumentListIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 5.25 6h.008a2.25 2.25 0 0 1 2.242 2.135 48.402 48.402 0 0 1-.5 7.536A2.25 2.25 0 0 1 5.25 18H3a2.25 2.25 0 0 1-2.25-2.25V6.108c0-1.135.845-2.098 1.976-2.192a48.424 48.424 0 0 1 1.123-.08" />
    </svg>
);
...
export const ReceiptPercentIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5v15a1.5 1.5 0 0 0 2.25 1.3l2.25-1.125 2.25 1.125 2.25-1.125 2.25 1.125 2.25-1.125a1.5 1.5 0 0 0 1.5-1.5v-15a1.5 1.5 0 0 0-1.5-1.5H5.25a1.5 1.5 0 0 0-1.5 1.5Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 8.25h3m-3 3h3m-3 3h3" />
    </svg>
);
